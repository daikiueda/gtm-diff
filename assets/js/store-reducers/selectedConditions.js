...
import {
    ...
    CLEAR_TAG_MANAGER_CONTAINER_SELECTION,
...
export default function selectedConditions( state = INITIAL_STATE, action = 0 ){
    switch( action.type ){
        ...
        case CLEAR_TAG_MANAGER_CONTAINER_SELECTION:
            return Object.assign( {}, state, {
                tagManagerContainer: null,
                prevTagManagerContainer: state.tagManagerContainer
            } );
